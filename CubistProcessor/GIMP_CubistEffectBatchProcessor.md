...
# GIMP Cubist Effect Batch Processor

This script is a Python plug-in for GIMP (GNU Image Manipulation Program), designed to apply a cubist effect to a batch of images in a specified directory.
